...
for SEED in $(seq $START_SEED $((NUM_SEEDS+START_SEED-1))); do
    ...
    python $FILE --experiment_id cover_expnodescreated --env cover --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_created
    python $FILE --experiment_id cover_expnodesexpanded --env cover --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_expanded
    ...
    python $FILE --experiment_id blocks_expnodescreated --env blocks --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_created
    python $FILE --experiment_id blocks_expnodesexpanded --env blocks --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_expanded
    ...
    python $FILE --experiment_id painting_expnodescreated --env painting --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_created
    python $FILE --experiment_id painting_expnodesexpanded --env painting --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_expanded
    ...
    python $FILE --experiment_id painting_always_open_expnodescreated --painting_lid_open_prob 1.0 --env painting --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_created
    python $FILE --experiment_id painting_always_open_expnodesexpanded --painting_lid_open_prob 1.0 --env painting --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_expanded
    ...
    python $FILE --experiment_id ctable_expnodescreated --env cluttered_table --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_created
    python $FILE --experiment_id ctable_expnodesexpanded --env cluttered_table --approach grammar_search_invention --excluded_predicates all $COMMON_ARGS --grammar_search_score_function expected_nodes_expanded
done
