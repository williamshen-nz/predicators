...
for SEED in $(seq $START_SEED $((NUM_SEEDS+START_SEED-1))); do
    ...
    for NUM_TRAIN_TASKS in ${ALL_NUM_TRAIN_TASKS[@]}; do
        ...
        # repeated_nextto
        python $FILE --experiment_id repeated_nextto_noinvent_noexclude_$NUM_TRAIN_TASKS --env repeated_nextto --approach nsrt_learning --learn_side_predicates True --repeated_nextto_num_dots 150 $COMMON_ARGS
