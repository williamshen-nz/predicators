...
try:
    ...
    pass  # sometimes doesn't work on supercloud...


def pause_pybullet(physics_client_id):
    """Pause pybullet, allowing interaction with the viewer
    """
    while True:
        p.setGravity(0, 0, -10, physics_client_id)
        time.sleep(0.01)
